...
public class  ProjectileProjection3DDrawProjection : MonoBehaviour
{
    ProjectileProjection3DCannonController cannonController;
    ...
    void Start()
    {
        cannonController = GetComponent<ProjectileProjection3DCannonController>();
